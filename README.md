...
The publication (*FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness*) by Dao et al. can be found [here](https://arxiv.org/abs/2205.14135). The video of this overview can be found [here](https://vanderbilt.box.com/s/wih40ierp26mzceoxy9xh69w0d782rko).
